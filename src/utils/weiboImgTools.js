...
function getImgURL (pid, type, https) {
  ...
  if (pid[9] == 'w' || (pid[9] == 'y' && pid.length >= 32)) {
    ...
    if (https) {
      url = pid[9] == 'w' ? 'https://ww' + zone + '.sinaimg.cn/' + type + '/' + pid + '.' + ext : 'https://wx' + zone + '.sinaimg.cn/' + type + '/' + pid + '.' + ext;
    } else {
      url = pid[9] == 'w' ? 'http://ww' + zone + '.sinaimg.cn/' + type + '/' + pid + '.' + ext : 'http://wx' + zone + '.sinaimg.cn/' + type + '/' + pid + '.' + ext;
    }
  } else {
...
export default function (pid) {
  return getImgURL(pid, 'large', true);
}
